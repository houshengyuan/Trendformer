...
from models.attn import TwoStageAttentionLayer
from models.model_basic import Base_Model

from math import ceil

class Trendformer(Base_Model):
    def __init__(self, data_dim, in_len, out_len, use_filter, win_size, merge_size = 2, hop_len = 3,
        ...
        base_predictor = Series_predictor(self.data_dim, self.in_len, self.out_len, self.win_size, self.use_filter, self.merge_size, self.hop_len,
...
class Series_predictor(nn.Module):
    def __init__(self, data_dim, in_len, out_len, win_size, use_filter, merge_size=2, hop_len=3,
        ...
        for i in range(e_layers):
            ...
            encode_list.append(TwoStageAttentionLayer(ceil(self.in_seg_num/merge_size**i), d_model//(merge_size**i), n_heads, \
                                                        d_ff//(merge_size**i), dropout))
